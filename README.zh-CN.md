...
如果你想最快看懂结果，优先打开各目录下的 `showcase.html`。

这一组快照已在 2026 年 4 月 6 日用本地运行结果刷新，不包含任何 live API 密钥。

### 实时金融发布包

- 主题：面向金融场景的受监管 AI 客服 copilot 发布计划
- 建议先看：[docs/demo/live/showcase.html](./docs/demo/live/showcase.html)
...
- JSON 结果：[docs/demo/live/showcase.json](./docs/demo/live/showcase.json)

### 企业 rollout 套件

- 主题：企业 AI operating layer 的 rollout、治理检查点与交付打包
- 建议先看：[docs/demo/enterprise/showcase.html](./docs/demo/enterprise/showcase.html)
...
- JSON 结果：[docs/demo/enterprise/showcase.json](./docs/demo/enterprise/showcase.json)

### 研究晋升包

- 主题：围绕“agent runtime 如何在真实任务上优于直接问模型”的深度研究与改进备忘录
- 建议先看：[docs/demo/research/showcase.html](./docs/demo/research/showcase.html)
...
- JSON 结果：[docs/demo/research/showcase.json](./docs/demo/research/showcase.json)
...
python -m app.main harness-live "写一份有证据支撑的研究简报"
```
